...
{
    public class UpdateRateRequest: IValidatableObject
    {
        ...
        //[Display(Name = "Detention")]
        //public int LoadDet { get; set; }
        ...
        [Display(Name = "Principal's Remarks")]
        public string PrincipalRemark { get; set; }

        public string AgentCostLI { get; set; }
        public IEnumerable<SelectListItem> ExportLocalCharges { get; set; }

        public IEnumerable<SelectListItem> ImportLocalCharges { get; set; }

        public List<string> SelectedExportLocalCharges { get; set; }

        public List<string> SelectedImportLocalCharges { get; set; }

        public UpdateRateRequest()
        {
            SelectedExportLocalCharges = new List<string>();
            SelectedImportLocalCharges = new List<string>();
        }

        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            if (ValidityDate < EffectiveDate)
            {
