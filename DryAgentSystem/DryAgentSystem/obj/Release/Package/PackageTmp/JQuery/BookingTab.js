$(function () {
   ...
   // jQuery.validator.methods["date"] = function (value, element) { return true; };
    ...
    if ($("#cutoffDatePicker").val() == "01-01-0001") {
        $("#cutoffDatePicker").datepicker("setDate", new Date());
    }

    $("#cutoffDatePicker").datepicker().next('button').button({
        icons: {
            primary: 'ui-icon-calendar'
        },
        text: false
    ...
    $("#cutoffDatePicker").datepicker().show();
