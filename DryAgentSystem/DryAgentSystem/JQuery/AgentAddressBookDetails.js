...
$(function () {
    ...
    $("#Save").click(function () {
       ...
       // var sim=$("#CompanyNamealert").hide().val();
        $("#Emailalert").hide();
    ...
    $("#CompanyName").on('change', function () {
        ...
        $.ajax({
            ...
            data: Boolean,
            url: "GetCompanyNames?agentaddressbook=" + CompanyName,
    ...
    var $s = $("#CountryDropDownList").selectmenu().selectmenu("menuWidget").addClass("overflow");
